        ...
        <div className="bg-white rounded-xl p-8 shadow-lg max-w-2xl mx-auto mb-12">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row space-x-6 mb-6">
              <a
                href="https://whatsapp.com/channel/0029VarAXPl7tkjEIzBbXq3r"
                className=" text-white p-3 rounded-full hover:bg-purple-900 transition-all hover:-translate-y-1"
              >
                <img src={whatsappIcon} className="w-12" />
              </a>
              <a
                href="https://t.me/InStayCreative_ISCs"
                className=" text-white p-3 rounded-full hover:bg-purple-900 transition-all hover:-translate-y-1"
              >
        ...
        <div className="hidden sm:grid sm:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-black font-medium text-sm sm:text-base">
                {service.label}
              </h3>
            </Link>
          ))}
